 ...
 *         &lt;element name="tipoDocumento" type="{http://www.cvera.com/webservices/schemas}TipoDocumento"/>
...
@XmlRootElement(name = "registrarUserRequest")
public class RegistrarUserRequest {
